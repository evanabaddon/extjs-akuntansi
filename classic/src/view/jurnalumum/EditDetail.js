Ext.define('Admin.view.jurnalumum.EditDetail', {
    ...
    constructor: function(c) {
        ...
        Ext.apply(c, {
            ...
            columns: [
                ...
                //--- [1]
                {xtype: 'gridcolumn', cls: 'content-column', text: 'Akun Kredit', flex: 1, menuDisabled: true, sortable: false, align: 'left', dataIndex: 'detail_akun', 
                    editor: {
                        xtype: 'combobox',
                        store: {
                            type: 'akun-level-4'
    ...
    getTotal: function() {
        ...
        me.up('jurnalumum-edit').down('#jumlah').setValue(total);
    },
